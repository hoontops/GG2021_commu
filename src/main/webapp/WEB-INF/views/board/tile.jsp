...
<body>
	...
	<section class="flex flex-row flex-wrap mx-auto items-center  place-content-center">
			...
			<div
              ...
              <path stroke-linecap="round" stroke-linejoin="round"
				...
				<p
					...
					${gameList.get(0).getG_GAME_INTRODUCTION()}
				</p>
				<hr class="border-gray-300" />
						...
						<div class="flex items-center flex-1">
							...
							<div class="flex flex-col mx-2">
								<a href="" class="font-semibold text-gray-700 hover:underline">
									${gameList.get(0).getG_CORPORATE_NAME()} </a> <span class="mx-1 text-xs text-gray-600">28
									Sep 2020</span>
							</div>
						</div>
        ...
        <div
          ...
          <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <p
                class="flex flex-row flex-wrap w-full px-4 py-2 overflow-hidden text-sm text-justify text-gray-700">
          ${gameList.get(1).getG_GAME_INTRODUCTION()}
            </p>
            <hr class="border-gray-300" />
            <section class="px-4 py-2 mt-2">
                <div class="flex items-center justify-between">
                    <div class="flex items-center flex-1">
                        ...
                        <div class="flex flex-col mx-2">
                            <a href="" class="font-semibold text-gray-700 hover:underline">
                                ${gameList.get(1).getG_CORPORATE_NAME()} </a> <span class="mx-1 text-xs text-gray-600">28
                                Sep 2020</span>
                        </div>
                    </div>
                    <p class="mt-1 text-xs text-gray-600">9 minutes read</p>
    ...
    <div
      ...
      <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <p
            class="flex flex-row flex-wrap w-full px-4 py-2 overflow-hidden text-sm text-justify text-gray-700">
           ${gameList.get(3).getG_GAME_INTRODUCTION()}
        </p>
        <hr class="border-gray-300" />
        <section class="px-4 py-2 mt-2">
            <div class="flex items-center justify-between">
                <div class="flex items-center flex-1">
                    ...
                    <div class="flex flex-col mx-2">
                        <a href="" class="font-semibold text-gray-700 hover:underline">
                            ${gameList.get(2).getG_CORPORATE_NAME() }</a> <span class="mx-1 text-xs text-gray-600">28
                            Sep 2020</span>
                    </div>
                </div>
                <p class="mt-1 text-xs text-gray-600">9 minutes read</p>
		...
		<div class="px-4">
			<div
				...
				<div class="md:flex">
					<div class="md:flex-shrink-0">
						<img class="h-48 w-full object-cover md:h-full md:w-48"
							src="${ gameList.get(4).getG_IMG()}" alt="Man looking at item at a store">
					</div>
					<div class="p-8">
						<div
			...
			<div class="flex flex-col lg:grid lg:gap-4 2xl:gap-6 lg:grid-cols-4 2xl:row-span-2 2xl:pb-8 ml-2 pt-4 px-4">
			  ...
			  <div class="bg-indigo-600 lg:order-1 lg:row-span-1 2xl:row-span-1 lg:col-span-2 rounded-lg shadow-xl mb-5 lg:mb-0">
				<div class="mx-4 my-8 2xl:mx-10">
				  <img class="w-70 sm:w-full md:w-full lg:w-full 2xl:w-full h-30 md:h-30 lg:h-30 2xl:h-30 rounded-b border-2 ml-1 md:-mt-1 2xl:-mt-4" src="${ gameList.get(5).getG_IMG()}" />
				...
				<div class="-mt-6 relative">
				  <p class="text-white text-xl 2xl:text-4xl font-bold px-7 lg:px-9 2xl:pt-6 2xl:mx-2">${gameList.get(5).getG_NAME()}</p>
				  <br />
				  <p class="text-white text-opacity-50 font-medium md:text-sm 2xl:text-3xl px-7 lg:px-9 mb-3 2xl:pb-8 2xl:mx-2">${gameList.get(5).getG_GAME_INTRODUCTION()}</p>
				</div>
			  </div>
			  ...
			  <div class="bg-gray-900 lg:order-2 lg:row-span-1 2xl:row-span-1 lg:col-span-1 rounded-lg shadow-xl pb-4 mb-5 lg:mb-0">
				<div class="mx-8 2xl:mx-10 my-10">
				  <img class="w-full md:w-full 2xl:w-full h-auto md:h-70 2xl:h-70 rounded-b border-2 -ml-1 -mt-2 lg:-mt-4" src="${ gameList.get(6).getG_IMG()}" />
				...
				<div class="-mt-8 mx-1 lg:mx-2">
				  <p class="text-white text-lg lg:text-xl 2xl:text-4xl font-semibold pt-1 px-6 2xl:px-8 lg:pl-5 lg:pr-8">${gameList.get(6).getG_NAME()}</p>
				  <br />
				  <p class="text-white text-opacity-50 font-medium md:text-sm 2xl:text-3xl pl-6 lg:pl-5 pr-4 -mt-1 lg:mt-6 2xl:mt-2 2xl:px-8">${gameList.get(6).getG_GAME_INTRODUCTION()}</p>
				</div>
			  </div>
			  ...
			  <div class="bg-primary-color-white lg:order-3 lg:row-span-2 2xl:row-span-1 lg:col-span-1 rounded-lg shadow-xl mb-5 lg:mb-0 2xl:mb-8">
				<div class="mx-8 my-10 lg:my-8">
				  <img class="w-full md:w-full lg:w-full 2xl:w-full h-70 md:h-70 lg:h-70 2xl:h-70 rounded-b border-1 -mt-2 -ml-1 lg:-ml-0" src="${ gameList.get(7).getG_IMG()}" />
				...
				<div class="-mt-4 ml-5 mr-11">
				  <p class="primary-color-blackish-blue text-xl 2xl:text-4xl font-bold px-2 lg:px-3 -mt-6 lg:-mt-5 2xl:mt-12 2xl:pb-6">${gameList.get(7).getG_NAME()}</p>
				  <br />
				  <p class="primary-color-blackish-blue-opacity font-medium md:text-sm 2xl:text-3xl pl-2 lg:pl-3 lg:pr-4 mb-6 2xl:pt-2 -mt-3">${gameList.get(7).getG_GAME_INTRODUCTION()}</p>
				</div>
			  </div>
			  ...
			  <div class="bg-purple-800 lg:order-4 lg:row-span-2 2xl:row-span-1 col-span-2 rounded-lg shadow-xl mb-5 lg:mb-0 2xl:mb-8 lg:pb-14 2xl:pb-20">
				<div class="mx-8 my-8">
				  <img class="w-full md:w-full lg:w-full 2xl:w-full h-70 md:h-70 lg:h-70 2xl:h-70 rounded-bl border-2 lg:-mt-3" src="${ gameList.get(8).getG_IMG()}" />
				...
				<div class="px-3 -mt-3 mb-5 lg:mb-0">
				  <p class="text-white text-lg 2xl:text-4xl font-semibold px-4 -mt-3 lg:-mt-6 2xl:mt-8">${gameList.get(8).getG_NAME()}</p>
				  <br />
				  <p class="text-white text-opacity-50 font-medium md:text-sm 2xl:text-3xl px-4 mt-1 lg:-mt-3 2xl:mt-6">${gameList.get(8).getG_GAME_INTRODUCTION()}</p>
				</div>
			  </div>
			  ...
			  <div class="bg-primary-color-white lg:order-2 lg:row-span-1 lg:col-span-1 rounded-lg shadow-xl mb-5 lg:pb-4 2xl:h-screen">
				<div class="mx-8 my-8 lg:pl-1">
				  <img class="w-full md:w-full lg:w-full 2xl:w-full h-70 md:h-70 lg:h-70 2xl:h-70 rounded-bl border-2 lg:-mt-4 -ml-1 lg:-ml-4" src="${ gameList.get(9).getG_IMG()}" />
				...
				<div class="px-3 lg:px-5 lg:-mt-4 mb-5 lg:mb-0">
				  <p class="primary-color-blackish-blue text-xl 2xl:text-4xl font-semibold px-4 lg:px-0 -mt-2 lg:-mt-0">${gameList.get(9).getG_NAME()}</p>
				  <br />
				  <p class="primary-color-blackish-blue-opacity font-medium md:text-sm 2xl:text-3xl px-4 lg:px-0 2xl:px-4 lg:pr-3 mt-2 lg:-mt-1 2xl:mt-2 2xl:pb-64">${gameList.get(9).getG_GAME_INTRODUCTION()}</p>
				</div>
			  </div>
              ...
              <div class="bg-gray-900 lg:order-2 lg:row-span-1 2xl:row-span-1 lg:col-span-1 rounded-lg shadow-xl pb-4 mb-5 lg:mb-0">
				<div class="mx-8 2xl:mx-10 my-10">
				  <img class="w-full md:w-full 2xl:w-full h-70 md:h-80 2xl:h-80 rounded-b border-2 -ml-1 -mt-2 lg:-mt-4" src="${ gameList.get(1).getG_IMG()}" />
				  <h1 class="text-white text-xs md:text-base 2xl:text-2xl text-right font-bold pl-11 md:pl-12 2xl:pl-24 -mt-8 md:-mt-10 2xl:-mt-16">Jonathan Walters</h1>
				  <h2 class="text-white text-xs md:text-base 2xl:text-2xl text-right text-opacity-80 font-bold pl-11 md:pl-12 2xl:pl-24">Verified Graduate</h2>
				</div>
				<div class="-mt-8 mx-1 lg:mx-2">
				  <p class="text-white text-lg lg:text-xl 2xl:text-4xl font-semibold pt-1 px-6 2xl:px-8 lg:pl-5 lg:pr-8">${gameList.get(1).getG_NAME()}</p>
				  <br />
				  <p class="text-white text-opacity-50 font-medium md:text-sm 2xl:text-3xl pl-6 lg:pl-5 pr-4 -mt-1 lg:mt-6 2xl:mt-2 2xl:px-8">${gameList.get(1).getG_GAME_INTRODUCTION()}</p>
				</div>
			  </div>
      </div>
