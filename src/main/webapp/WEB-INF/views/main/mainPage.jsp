...
<!-- 여기부터 작업하세요 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ --> 
<div>
 <section class="rounded-md w-full md:w-5/6 md:mx-auto">
    <main class="flex flex-col justify-center rounded-b-md">
        <div class="flex flex-col justify-center items-center p-2">
            ...
            <div class="w-3/4 items-center">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-6">
...
<div class="p-1 md:w-1/3 flex-auto">
      ...
      <div class="p-4 md:w-1/3 flex-auto">
        <div class="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1049&q=80" alt="blog">
          <div class="p-6">
            <h2 class="tracking-widest text-xs title-font font-medium text-gray-500 mb-1">CATEGORY</h2>
...
<!-- End Profile Card -->
    ...
    <div class="w-full grid grid-col-3 place-items-center py-4">
                <div class="px-2 flex gap-10">
                    ...
                    <div class="col-1 flex items-center bg-indigo-100  bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-yellow-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-blue-900 hover:bg-opacity-100 transition">
                      <img class="w-12 h-12" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuGQ7P4_tiG4OJSW5DQ2K7e1JWM1aDV3fK3g&usqp=CAU" alt="tetris" />
                      <div>
                        <span class="font-bold text-black">Tetris</span>
                        <span class="text-xs text-black block">Our Game</span>
                      </div>
                      <div>
                    ...
                    <div class="col-1 flex items-center bg-indigo-100  bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-yellow-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-blue-900 hover:bg-opacity-100 transition">
                        <img class="w-12 h-12" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0DmVFrC6kKUDq-fONpy0n0-pDKdpG4UZtbQ&usqp=CAU" alt="룰렛" />
                        <div>
                          <span class="font-bold  text-black ">roulette</span>
                          <span class="text-xs  text-black  block">Our Game</span>
                        </div>
                        <div>
                          <i class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
             ...
             <!--3버튼끝  -->   
 <!--4칸 메모  -->
  <div class="w-full flex px-6 shadow-2xl py-3 items-start overflow-x-scroll">
    <!-- 1 -->
    <div class="rounded-bl bg-grey-LIGHT flex-no-shrink w-64 p-2 ml-5 mr-10 border-2 shadow-xl xl:w-96">
        <div class="flex justify-between py-2">
            <h3 class="text-MD font-bold shadow-md ml-16">GAME 커뮤니티</h3>
        ...
        <div class="text-sm mt-2">
          ...
          <p class="mt-3 text-grey-dark text-right">더보기...</p>
     </div>

     <!-- 2 -->
     <div class="rounded-bl bg-grey-LIGHT flex-no-shrink w-64 p-2 mr-10 border-2 shadow-xl  xl:w-96">
      <div class="flex justify-between py-2">
          <h3 class="text-MD font-bold shadow-md ml-16">커뮤니티</h3>
          <svg class="h-4 fill-current text-grey-dark cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5 10a1.999 1.999 0 1 0 0 4 1.999 1.999 0 1 0 0-4zm7 0a1.999 1.999 0 1 0 0 4 1.999 1.999 0 1 0 0-4zm7 0a1.999 1.999 0 1 0 0 4 1.999 1.999 0 1 0 0-4z"/></svg>
      </div>
      <div class="text-sm mt-2">
          <div class="bg-white p-2 rounded mt-1 border-b border-grey cursor-pointer hover:bg-grey-lighter">
   ...
   <div class="rounded-bl bg-grey-LIGHT flex-no-shrink w-64 p-2 mr-10 border-2 shadow-xl  xl:w-96">
    <div class="flex justify-between py-2">
        <h3 class="text-MD font-bold shadow-md ml-16">GAME NAME</h3>
        <svg class="h-4 fill-current text-grey-dark cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5 10a1.999 1.999 0 1 0 0 4 1.999 1.999 0 1 0 0-4zm7 0a1.999 1.999 0 1 0 0 4 1.999 1.999 0 1 0 0-4zm7 0a1.999 1.999 0 1 0 0 4 1.999 1.999 0 1 0 0-4z"/></svg>
    </div>
    <div class="text-sm mt-2">
        <div class="bg-white p-2 rounded mt-1 border-b border-grey cursor-pointer hover:bg-grey-lighter">
...
<!-- 테이블 시작 -->
                ...
                <div class="col-start-1 col-end-6 align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
                    <table class="min-w-full">
                        <thead>
                            <tr>
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">순위</th>
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">게임명</th>
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">장르</th>
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">가격</th>
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">출시일</th>
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">아몰랑</th>
                        ...
                        <tbody class="bg-white">
                                <tr>
                                    ...
                                    <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">September 12</td>
...
<form>   
    ...
    <button
      id="w3f__widget--btn"
      @click="open = !open"
      class="fixed z-40 right-5 bottom-20 shadow-lg flex justify-center items-center w-14 h-14 bg-indigo-500 rounded-full focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 transition duration-300 ease"
    >
      <svg
        class="w-6 h-6 text-white absolute fas fa-folder-minus"
        x-show="!open"
