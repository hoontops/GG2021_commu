...
<div class="p-1 md:w-1/3 flex-auto">
        <div class="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
          ...
          <div class="p-6">
            <h2 class="tracking-widest text-xs title-font font-medium text-gray-500 mb-1">${game.getG_TYPE() }</h2>
...
<%-- <div class="flex items-center justify-center">
 ...
 <div class="w-full grid grid-col-3 place-items-center py-4">
	<div class= "text-center font-bolder font-xl py-3">스크립트 게임</div>
...
<!-- 테이블 시작 -->
                ...
                <div class="col-start-1 col-end-6 align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
                    <table class="min-w-full">
                        <thead>
                            <tr>
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">장르</th>
                                ...
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">서버상태</th>
                                <th class="px-3 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">평점</th>
                        ...
                        <tbody class="bg-white">
                             <c:forEach var="a" items="${gameList }"> 
                                <tr>
                                    ...
                                    <td class="px-3 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">${a.getG_DATE()}</td>
                                    <td class="px-3 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5 font-bold">${a.getG_PRICE()} 원</td>
                                    <td class="px-3 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                                        <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                                        <span aria-hidden class="absolute inset-0 bg-green-600 opacity-50 rounded-full"></span>
                                        <span class="relative text-xs">active</span>
                                    </span>
                                    </td>
                                    <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">${a.getG_GRADE()}</td>
